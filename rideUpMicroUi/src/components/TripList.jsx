    ...
    <section className="space-y-3">
      <header className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
        <div className="flex items-center gap-2.5">
          <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-r from-orange-500 via-red-500 to-rose-600 text-white shadow-sm">
            ↔
          </span>
          <div>
        ...
        <div className="mt-2.5 rounded-lg border border-slate-100 bg-slate-50 px-2.5 py-1.5 text-xs text-slate-600">
