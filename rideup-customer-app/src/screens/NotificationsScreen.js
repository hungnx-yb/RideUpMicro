...
const NotificationItem = ({ item, onPress }) => {
  ...
  const bgColor = isRead ? COLORS.surface : 'rgba(255,215,0,0.08)';
...
const styles = StyleSheet.create({
  ...
  markAllBtn: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255,215,0,0.1)', alignItems: 'center', justifyContent: 'center' },
